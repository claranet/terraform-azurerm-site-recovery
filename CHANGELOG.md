...
* **tflint:** 🐛 bump Azure rules version, fix signature bug b3eb9b8

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.1 ffdabcd
* **deps:** update dependency opentofu to v1.12.2 a963f30
* **deps:** update dependency opentofu to v1.12.3 e1eda6a
* **deps:** update dependency opentofu to v1.12.4 1277eb8
* **deps:** update dependency tflint to v0.63.1 f8927d8
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 317bbe1
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 c5bb04d

## 8.0.4 (2026-06-02)

### Bug Fixes

* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 9cd997a

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 0bee5ed
* **deps:** update dependency opentofu to v1.11.7 810e6a6
* **deps:** update dependency opentofu to v1.12.0 3ad52b3
* **deps:** update dependency terraform-docs to v0.23.0 3a16106
* **deps:** update dependency terraform-docs to v0.24.0 5b3e012
* **deps:** update dependency tflint to v0.62.1 91e24b0
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 487e35a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 f6f09d2
* **pre-commit:** 🔧 move to prek 85b68db
* **tfdocs:** bump tfdocs to v0.22 🔧 c10d07d

## 8.0.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ ec74e7c

### Code Refactoring

* update module structure and Github actions 👷 4489253

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 8917579
* **deps:** 🔗 bump tflint rules version c908db1
* **deps:** update dependency trivy to v0.69.2 d76b81e
* **deps:** update dependency trivy to v0.69.3 c55c036
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 29cfee5

## 8.0.2 (2026-02-13)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 7ed0a6c

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.7 b9d9624
* **deps:** update dependency opentofu to v1.11.2 5057f9e
* **deps:** update dependency opentofu to v1.11.3 db5ad4b
* **deps:** update dependency opentofu to v1.11.4 aba19ee
* **deps:** update dependency opentofu to v1.11.5 8312ca6
* **deps:** update dependency pre-commit to v4.4.0 f2e477a
* **deps:** update dependency pre-commit to v4.5.0 c799ef8
* **deps:** update dependency pre-commit to v4.5.1 07e74ed
* **deps:** update dependency tflint to v0.60.0 1c75a61
* **deps:** update dependency tflint to v0.61.0 7252ea1
* **deps:** update dependency trivy to v0.67.1 765fd56
* **deps:** update dependency trivy to v0.67.2 0fd497c
* **deps:** update dependency trivy to v0.68.1 9545acd
* **deps:** update dependency trivy to v0.68.2 a26889f
* **deps:** update dependency trivy to v0.69.0 ffd7884
* **deps:** update dependency trivy to v0.69.1 3ccb4af
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 570ad92
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 d9c54f1
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 5aa3dfa
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 8a182ca
* **deps:** update tools 919202b
